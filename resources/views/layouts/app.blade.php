        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="d-lg-none"><a href="{{url('/home')}}"><span class="mr-2">+</span> Post a Job</a></li>
            @guest
                    @if (Route::has('login'))
      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This is made </i> by Guna <i class="icon-heart text-danger" aria-hidden="true"></i></a>.
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small></p>
          </div>
        </div>
      </div>
    </footer>
    <!-- Our own scripts for styling -->
