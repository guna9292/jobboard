        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="mb-5">
                            <figure class="mb-5 mt-4"><img src="{{asset('assets/images/job_single_img_1.jpg')}}" alt="Image" class="img-fluid rounded"></figure>
                        ...
                        <p class="mb-5">
                            ...
                            @foreach(explode('-', $job->responsibilities) as $item)
                                @if(trim($item) !== '')
                                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{ $item }}</span></li>
                                @endif
                                @endforeach
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="list-unstyled m-0 p-0">
                                @foreach(explode('-', $job->education_experience) as $item)
                                @if(trim($item) !== '')
                                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{ $item }}</span></li>
                                @endif
                                @endforeach
                        ...
                        <div class="mb-5">
                            ...
                            @foreach(explode('-', $job->otherbenefits) as $item)
                                @if(trim($item) !== '')
                                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{ $item }}</span></li>
                                @endif
                                @endforeach
                        ...
                        <div class="row mb-5">
                            <div class="col-6">
                                ...
                                <form action="{{route('save.job')}}" method="POST">
                                    ...
                                    @if ($savedJob>0)
                                        <button class="btn btn-block btn-success btn-md" disabled><i class="icon-heart"> </i> Saved Already!</button>
                                    @else
                            ...
                            <div class="col-6">
                                @if(!empty($job->url))
                                    <a href="{{$job->url}}" class="btn btn-block btn-primary btn-md">Apply at site</a>
                                @else
                                    <form action="{{route('apply.job')}}" method="POST">
                                         @csrf
                                                ...
                                                @if ($appliedJob>0)
                                                <button class="btn btn-block btn-success btn-md" disabled>Applied Already!</button>
                                                @else
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="bg-light p-3 border rounded">
                              ...
                              <div class="px-3">
                                ...
                                <a href="https://api.whatsapp.com/send?text={{route('single.job',$job->id)}}" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-whatsapp"></span></a>
